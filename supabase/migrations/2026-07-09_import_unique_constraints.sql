...
-- 9.7.2026 obstaja 8 podvojenih EMŠO (16 zapisov), pri 7 sta oba zapisa na rosterju
-- (npr. IGOR TURK/Igor Turk, Bojc Šepić x2, Franjo Rous x2 — ista oseba ustvarjena dvakrat
-- med zgodovinskimi uvozi; ligaška pot je razcepljena med zapisoma).
-- Poseben primer: EMŠO 2712982500033 imata DVE RAZLIČNI osebi (Silvan Strle, Goran Gavrić)
-- → eden od njiju ima napačen EMŠO.
