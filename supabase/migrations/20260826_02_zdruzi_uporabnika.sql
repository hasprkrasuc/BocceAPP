-- Združitev dveh zapisov iste osebe — prestavitev vseh sklicev.
--
...
--
-- Funkcija NE briše prijavnega računa (auth.users) in NE prepisuje podatkov na
-- obdržanem zapisu — to opravi api/user-merge.ts po uspešnem klicu. Vrstni red
-- je namenoma tak: če bi bris uspel, prestavitev pa ne, bi bili podatki
-- izgubljeni. Obratno ostane le odvečen prazen zapis, ki ga je mogoče pobrisati
-- pozneje.
...
begin
  ...
  -- ── Sprostitev unikatnih vrednosti na opuščenem zapisu ────
  -- users_emso_uniq je delni unikat: dokler EMŠO stoji tu, ga ni mogoče
  -- zapisati na obdržani zapis.
