...
import { pokalniPajek, POKAL_VELIKOST, type PokalEkipa, type PokalIzid } from '../engines/pokal'
...
export default function Pokal() {
  ...
  async function nalozi() {
    ...
    try {
      ...
      const [{ data: e, error: eErr }, { data: t, error: tErr }] = await Promise.all([
        supabase.from('league_teams')
          .select('id, club_name, draw_number, club:clubs(logo_url)')
